...
#ifndef DPLX_PREDEF_COMPILER_NVCC_H
#define DPLX_PREDEF_COMPILER_NVCC_H
...
#define DPLX_COMP_NVCC DPLX_VERSION_NUMBER_NOT_AVAILABLE

#if defined(__NVCC__)
#   if !defined(__CUDACC_VER_MAJOR__) || !defined(__CUDACC_VER_MINOR__) || !defined(__CUDACC_VER_BUILD__)
#       define DPLX_COMP_NVCC_DETECTION DPLX_VERSION_NUMBER_AVAILABLE
#   else
#       define DPLX_COMP_NVCC_DETECTION DPLX_VERSION_NUMBER(__CUDACC_VER_MAJOR__, __CUDACC_VER_MINOR__, __CUDACC_VER_BUILD__)
#   endif
#endif

#ifdef DPLX_COMP_NVCC_DETECTION
/*
Always define DPLX_COMP_NVCC instead of DPLX_COMP_NVCC_EMULATED
...
allowed to set DPLX_COMP_NVCC additionally to the already detected host
...
*/
#   undef DPLX_COMP_NVCC
#   define DPLX_COMP_NVCC DPLX_COMP_NVCC_DETECTION
#   define DPLX_COMP_NVCC_AVAILABLE
#   include <dplx/predef/detail/comp_detected.h>
#endif

#define DPLX_COMP_NVCC_NAME "NVCC"

#endif

#include <dplx/predef/detail/test.h>
DPLX_PREDEF_DECLARE_TEST(DPLX_COMP_NVCC,DPLX_COMP_NVCC_NAME)
