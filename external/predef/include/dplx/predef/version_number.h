...
#ifndef DPLX_PREDEF_VERSION_NUMBER_H
#define DPLX_PREDEF_VERSION_NUMBER_H
...
[source]
----
DPLX_VERSION_NUMBER(major,minor,patch)
----
...
*/ // end::reference[]
#define DPLX_VERSION_NUMBER(major,minor,patch) \
    ( (((major)%100)*10000000) + (((minor)%100)*100000) + ((patch)%100000) )

#define DPLX_VERSION_NUMBER_MAX \
    DPLX_VERSION_NUMBER(99,99,99999)

#define DPLX_VERSION_NUMBER_ZERO \
    DPLX_VERSION_NUMBER(0,0,0)

#define DPLX_VERSION_NUMBER_MIN \
    DPLX_VERSION_NUMBER(0,0,1)

#define DPLX_VERSION_NUMBER_AVAILABLE \
    DPLX_VERSION_NUMBER_MIN

#define DPLX_VERSION_NUMBER_NOT_AVAILABLE \
    DPLX_VERSION_NUMBER_ZERO

/* tag::reference[]
[source]
----
DPLX_VERSION_NUMBER_MAJOR(N), DPLX_VERSION_NUMBER_MINOR(N), DPLX_VERSION_NUMBER_PATCH(N)
----
...
respectively.
*/ // end::reference[]
#define DPLX_VERSION_NUMBER_MAJOR(N) \
    ( ((N)/10000000)%100 )

#define DPLX_VERSION_NUMBER_MINOR(N) \
    ( ((N)/100000)%100 )

#define DPLX_VERSION_NUMBER_PATCH(N) \
    ( (N)%100000 )
