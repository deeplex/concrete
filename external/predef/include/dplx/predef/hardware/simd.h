...
#include <dplx/predef/hardware/simd/x86_amd.h>
#include <dplx/predef/hardware/simd/arm.h>
#include <dplx/predef/hardware/simd/ppc.h>

#ifndef DPLX_PREDEF_HARDWARE_SIMD_H
#define DPLX_PREDEF_HARDWARE_SIMD_H

#include <dplx/predef/version_number.h>

/* tag::reference[]
= Using the `DPLX_HW_SIMD_*` predefs
...
[source]
----
#include <dplx/predef/hardware/simd.h>
#include <iostream>

int main()
{
#if defined(DPLX_HW_SIMD_AVAILABLE)
...
compare it. Those predef are of the form `DPLX_HW_SIMD_"ARCH"` (where `"ARCH"`
is either `ARM`, `PPC`, or `X86`). For example, if you compile code for x86
architecture, you will have to use `DPLX_HW_SIMD_X86`. Its value will be the
...
int main()
{
#if DPLX_HW_SIMD_X86 >= DPLX_HW_SIMD_X86_SSE3_VERSION
...
int main()
{
#if DPLX_HW_SIMD_X86 >= DPLX_HW_SIMD_X86_SSE2_VERSION &&\
    DPLX_HW_SIMD_X86 <= DPLX_HW_SIMD_X86_SSSE3_VERSION
...
//
#if defined(DPLX_HW_SIMD_ARM_AVAILABLE) && defined(DPLX_HW_SIMD_PPC_AVAILABLE) ||\
    defined(DPLX_HW_SIMD_ARM_AVAILABLE) && defined(DPLX_HW_SIMD_X86_AVAILABLE) ||\
    defined(DPLX_HW_SIMD_PPC_AVAILABLE) && defined(DPLX_HW_SIMD_X86_AVAILABLE)
#   error "Multiple SIMD architectures detected, this cannot happen!"
#endif

#if defined(DPLX_HW_SIMD_X86_AVAILABLE) && defined(DPLX_HW_SIMD_X86_AMD_AVAILABLE)
...
#      define DPLX_HW_SIMD DPLX_HW_SIMD_X86
#   else
#      define DPLX_HW_SIMD DPLX_HW_SIMD_X86_AMD
#   endif
#endif

#if !defined(DPLX_HW_SIMD)
    // At this point, only one of these two is defined
#   if defined(DPLX_HW_SIMD_X86_AVAILABLE)
#      define DPLX_HW_SIMD DPLX_HW_SIMD_X86
#   endif
#   if defined(DPLX_HW_SIMD_X86_AMD_AVAILABLE)
#      define DPLX_HW_SIMD DPLX_HW_SIMD_X86_AMD
#   endif
#endif

#if defined(DPLX_HW_SIMD_ARM_AVAILABLE)
#   define DPLX_HW_SIMD DPLX_HW_SIMD_ARM
#endif

#if defined(DPLX_HW_SIMD_PPC_AVAILABLE)
#   define DPLX_HW_SIMD DPLX_HW_SIMD_PPC
#endif

#if defined(DPLX_HW_SIMD)
#   define DPLX_HW_SIMD_AVAILABLE
#else
#   define DPLX_HW_SIMD DPLX_VERSION_NUMBER_NOT_AVAILABLE
#endif

#define DPLX_HW_SIMD_NAME "Hardware SIMD"

#endif

#include <dplx/predef/detail/test.h>
DPLX_PREDEF_DECLARE_TEST(DPLX_HW_SIMD, DPLX_HW_SIMD_NAME)
