...
#ifndef DPLX_PREDEF_ARCHITECTURE_ARM_H
#define DPLX_PREDEF_ARCHITECTURE_ARM_H
...
#define DPLX_ARCH_ARM DPLX_VERSION_NUMBER_NOT_AVAILABLE
...
#   undef DPLX_ARCH_ARM
#   if !defined(DPLX_ARCH_ARM) && defined(__ARM_ARCH)
#       define DPLX_ARCH_ARM DPLX_VERSION_NUMBER(__ARM_ARCH,0,0)
#   endif
#   if !defined(DPLX_ARCH_ARM) && defined(__TARGET_ARCH_ARM)
#       define DPLX_ARCH_ARM DPLX_VERSION_NUMBER(__TARGET_ARCH_ARM,0,0)
#   endif
#   if !defined(DPLX_ARCH_ARM) && defined(__TARGET_ARCH_THUMB)
#       define DPLX_ARCH_ARM DPLX_VERSION_NUMBER(__TARGET_ARCH_THUMB,0,0)
#   endif
#   if !defined(DPLX_ARCH_ARM) && defined(_M_ARM)
#       define DPLX_ARCH_ARM DPLX_VERSION_NUMBER(_M_ARM,0,0)
#   endif
#   if !defined(DPLX_ARCH_ARM) && ( \
        defined(__arm64) || defined(_M_ARM64) || defined(__aarch64__) || \
        defined(__AARCH64EL__) )
#       define DPLX_ARCH_ARM DPLX_VERSION_NUMBER(8,0,0)
#   endif
#   if !defined(DPLX_ARCH_ARM) && ( \
    defined(__ARM_ARCH_7__) || defined(__ARM_ARCH_7A__) || \
    defined(__ARM_ARCH_7R__) || defined(__ARM_ARCH_7M__) )
#       define DPLX_ARCH_ARM DPLX_VERSION_NUMBER(7,0,0)
#   endif
#   if !defined(DPLX_ARCH_ARM) && ( \
    defined(__ARM_ARCH_6K__) || defined(__ARM_ARCH_6Z__) || \
    defined(__ARM_ARCH_6KZ__) || defined(__ARM_ARCH_6T2__) )
#       define DPLX_ARCH_ARM DPLX_VERSION_NUMBER(6,0,0)
#   endif
#   if !defined(DPLX_ARCH_ARM) && ( \
    defined(__ARM_ARCH_5TE__) || defined(__ARM_ARCH_5TEJ__) )
#       define DPLX_ARCH_ARM DPLX_VERSION_NUMBER(5,0,0)
#   endif
#   if !defined(DPLX_ARCH_ARM) && ( \
    defined(__ARM_ARCH_4T__) || defined(__ARM_ARCH_4__) )
#       define DPLX_ARCH_ARM DPLX_VERSION_NUMBER(4,0,0)
#   endif
#   if !defined(DPLX_ARCH_ARM)
#       define DPLX_ARCH_ARM DPLX_VERSION_NUMBER_AVAILABLE
#   endif
#endif

#if DPLX_ARCH_ARM
#   define DPLX_ARCH_ARM_AVAILABLE
#endif

#if DPLX_ARCH_ARM
#   if DPLX_ARCH_ARM >= DPLX_VERSION_NUMBER(8,0,0)
...
#define DPLX_ARCH_ARM_NAME "ARM"

#endif

#include <dplx/predef/detail/test.h>
DPLX_PREDEF_DECLARE_TEST(DPLX_ARCH_ARM,DPLX_ARCH_ARM_NAME)
